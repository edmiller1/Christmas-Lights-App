...
interface Props {
  getVerificationRequestsLoading: boolean;
}

export const RecentVerificationsTable = ({
  getVerificationRequestsLoading,
}: Props) => {
  if (getVerificationRequestsLoading) {
    return <TableLoading />;
  }
  return (
    <>
      <h2 className="mx-auto mt-8 max-w-4xl text-lg font-medium leading-6">
      ...
      <div className="shadow sm:hidden">
        ...
        >
          <li>
            <div className="block bg-zinc-900 px-4 py-4">
