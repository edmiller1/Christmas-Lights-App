          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-zinc-900">
                ...
                <button
                  className="w-full mt-10 px-3 py-3 flex items-center justify-between rounded-lg border text-ch-dark hover:bg-gray-100 dark:text-ch-light dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-900"
                  onClick={copyLink}
                >
                  <p>Copy Link</p>
                  <Copy
                ...
                <div className="w-full mt-5 rounded-tr-lg rounded-tl-lg border rounded-bl-lg rounded-br-lg text-ch-dark dark:text-ch-light dark:border-zinc-700 dark:bg-zinc-800">
                  <EmailShareButton
                    ...
                    className="w-full"
                    children={
                      <div className="w-full flex items-center justify-between px-3 py-3 rounded-tr-lg rounded-tl-lg hover:bg-gray-100 dark:hover:bg-zinc-900">
                        <p>Email</p>
                        <Envelope
                          size={28}
                          className="mr-5 ml-2 text-ch-dark dark:text-ch-light"
                  ...
                  <FacebookMessengerShareButton
                    ...
                    className="w-full"
                    children={
                      <div className="w-full flex items-center justify-between px-3 py-3 hover:bg-gray-100 dark:hover:bg-zinc-900">
                        <p>Messenger</p>
                        <MessengerLogo
                          size={28}
                  ...
                  <TwitterShareButton
                    ...
                    className="w-full"
                    children={
                      <div className="w-full flex items-center justify-between px-3 py-3 rounded-br-lg rounded-bl-lg hover:bg-gray-100 dark:hover:bg-zinc-900">
                        <p>Twitter</p>
                        <TwitterLogo
                          size={28}
                          className="mr-5 ml-2 dark:text-ch-light"
