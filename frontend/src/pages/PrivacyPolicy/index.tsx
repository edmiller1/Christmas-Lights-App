      ...
      <div className="mt-16">
        ...
        <div className="mt-10">
          <p className="mt-3">
            ...
            information in connection with your use of our mobile application or
            website, Christmas Lights App ("App").
          </p>
        </div>
        <div className="mt-10">
        ...
        <div className="mt-10">
          <h2 className="font-semibold text-xl">2. Use of Your Information</h2>
          <p className="mt-3">
            We may use your information for the following purposes:
            <ul className="list-disc ml-12">
              <li>
                To provide and operate the App, including to allow you to create
                and view Christmas decorations.
              </li>
        ...
        <div className="mt-10">
          ...
          <p className="mt-3">
            ...
            help us operate the App, such as cloud storage providers or
        ...
        <div className="mt-10">
          <h2 className="font-semibold text-xl">7. International Transfers</h2>
          <p className="mt-3">
        ...
        <div className="mt-10">
          ...
          <p className="mt-3">
            ...
            depending on the law of your jurisdiction. These rights may include
            the right to access, correct, or delete your information, or to
