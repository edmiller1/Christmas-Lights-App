    ...
    <>
      ...
      <div className="p-3 mb-5 flex items-center justify-between rounded-xl dark:bg-zinc-800">
        ...
        >
          <div
            className={classNames(
              selectedIcon === "map" ? "bg-primary text-white" : "",
        ...
        >
          <div
            className={classNames(
              selectedIcon === "route-planning" ? "bg-primary text-white" : "",
              "rounded-full p-3 text-sm"
            )}
          >
        ...
        >
          <div
            className={classNames(
              selectedIcon === "favourites" ? "bg-primary text-white" : "",
              "rounded-full p-3 text-sm"
            )}
          >
        ...
        >
          <div
            className={classNames(
              selectedIcon === "history" ? "bg-primary text-white" : "",
              "rounded-full p-3 text-sm"
            )}
          >
