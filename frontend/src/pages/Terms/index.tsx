        ...
        <div className="mt-16">
          ...
          <div className="mt-10">
            <p>
              ...
              Christmas Lights App mobile application and website (the "App").
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              <strong>1.2</strong> You are solely responsible for all content
              that you upload, post, or otherwise transmit through the App
              ("User Content"). You represent and warrant that you have all
              rights necessary to upload or transmit such User Content and to
              grant the rights and licenses set forth in these Terms.
            </p>
            <p className="mt-3 text-justify">
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              <strong>2.3</strong> You agree not to interfere with or disrupt
              the servers or networks used by the App.
            </p>
            <p className="mt-3 text-justify">
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              ...
              the property of Christmas Lights App or its licensors and are
              protected by copyright, trademark, and other intellectual property
              laws.
            </p>
            <p className="mt-3 text-justify">
              <strong>3.2</strong> You may not modify, publish, distribute,
              create derivative works of, reverse engineer, decompile, or
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              ...
              PROFITS, LOSS OF USE, LOSS OF DATA, OR OTHER INTANGIBLE LOSSES)
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              <strong>6.1</strong> We may terminate your access to the App for
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              <strong>7.1</strong> These Terms shall be governed by and
              construed in accordance with the laws of Australia and New
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              ...
              between you and Christmas Lights App regarding your use of the
              App.
            </p>
          </div>
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 text-justify">
              ...
              traditions and practices vary around the world. We encourage you
              to be respectful of all cultures and beliefs.
            </p>
          </div>
        </div>
      </div>
