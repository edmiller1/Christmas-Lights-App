  ...
  return (
    <>
      ...
      <div className="sm:hidden">
        <Transition appear show={showActiveDecoration} as={Fragment}>
          <Dialog
            ...
            onClose={() => setShowActiveDecoration(true)}
          >
            <Transition.Child
              as={Fragment}
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-white/80 backdrop-blur-sm dark:bg-zinc-950/80 opacity-10" />
            </Transition.Child>
      ...
      <motion.div
        ...
        className="hidden sm:block absolute bottom-10 right-2 w-72 rounded-xl bg-white text-black p-2"
      >
        <div className="flex items-center justify-between py-1 px-2">
